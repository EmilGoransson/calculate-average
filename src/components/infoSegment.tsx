            ...
            <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                        ...
                        <div onClick={() => {
                            window.open("https://www.kth.se/student/studier/utlandsstudier/utbyte/behorighet-och-urval-for-utbytesstudier-1.1090201", "_blank")
                        }}><HoverCard>
                ...
                <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                        Probably due to poor coding, or alternatively, it’s a course you received an F in that doesn’t
                        contain any approved sub-modules (it doesn’t show up in the PDF file then). </AccordionContent>
                </AccordionItem>
            </Accordion>
        </div>
    );
